...
window.Map = {
	...
	init: function (blocks) {
		...
		this.blocks = blocks || [
			...
			[5,10,10,10, 1, _, _, _, _, 6, 6, _, _, _, _, _, _, _, _, 6, 6, _, _, _, _, 1,11,11,11, 5],
			[5,10,10,10, 1, _, _, _, _, 6, 6, _, _, 1,24, _, 1, _, _, 2, 2, _, _, _, _, 1,11,11,11, 5],
			[5,10,10,10, 1, _, _, _, _, 2, 2, _, _, 1, _, _, 1, _, _, 6, 6, _, _, _, _, 1,11,11,11, 5],
			[5,10,10,10, 1, _, _, _, _, 6, 6, _, _, _, _, _, _, _, _, 6, 6, _, _, _, _, 1,11,11,11, 5],
			[5, 1, 1, 1, 1, _, _, _, _, 6, 6, _, _, _, _, _, _, _, _, 2, 2, _, _, _, _, 1, 1, 1, 1, 5],
